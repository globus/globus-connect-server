...
is(default_dir($endpoint_name), "/tmp", "is_default_dir_tmp");
...
# Test Step #6:
# Check that endpoint's DefaultDirectory attribute is /tmp
is(default_dir($endpoint_name), "/tmp", "is_default_dir_still_tmp");
...
is(default_dir($endpoint_name), "/home", "is_default_dir_home");
...
# Test Step #12:
# Check that endpoint's DefaultDirectory attribute is "/tmp"
is(default_dir($endpoint_name), "/tmp", "is_default_dir_back_to_tmp");
